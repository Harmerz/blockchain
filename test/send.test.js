    ...
    const productRecords = [
      {
        shipmentID: 0,
        weight: 5,
        timestamp: inventoryAfter.productRecords.filter((e) => hexToDecimal(e.weight) === 100)[0]
          .timestamp,
      },
      {
        shipmentID: 0,
        weight: 10,
        timestamp: inventoryAfter.productRecords.filter((e) => hexToDecimal(e.weight) === 50)[0]
          .timestamp,
      },
    ]
    const reduceweight = 15
    await supplyChain.sendShipment(
      userAddress1,
      userAddress2,
      reduceweight,
      productId,
